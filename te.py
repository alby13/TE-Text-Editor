# TE (Text Editor) - Build 8, 6-23-2025 - Copyright 2024-2025, All Rights Reserved.
...
class Menu:
    def __init__(self, items):
        ...
        self.open = False
        self.submenus = {
            "File": ["New", "Open", "Save", "Save as", "Exit"],            "Edit": ["Undo", "Redo", "Cut", "Copy", "Paste"],
...
class TextEditor:
    ...
    def _ensure_cursor_visible(self):
        ...
        # The content area is the screen height minus the menu bar (1) and two status bars (2).
    ...
    def delete_selected_text(self, save_state=True):
        ...
        if y1 == y2:
            ...
            # 2. Delete all the lines that were in between.
    ...
    def handle_menu_action(self, action):
        ...
        if menu == "File":
            ...
            if item == "User Manual":
                ...
                self.message = "ABOUT: TE (Text Editor) Version 8 - It's pretty good."
